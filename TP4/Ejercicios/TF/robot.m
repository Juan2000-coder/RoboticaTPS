...
distancia_BASE = 0.1;
transl_base = [0 0 distancia_BASE];
roll_base   = 0;
pitch_base  = 0;
yawn_base   = 0;

% traslación y rotación de la herramienta
distancia_TCP = 0;      % esta es la distancia de traslación desde el 
                        % origen del último sistema hasta el TCP, aún
                        % no definida
transl_tool = [0 0 distancia_TCP];
roll_tool   = 0;
pitch_tool  = 0;
yawn_tool   = 0;
