...
Sin embargo, otra alternativa podría ser exigir que al menos dos de las variables en la formulación del problema sean congruentes entre sí aunque la tercera no lo sea.
...
Para tomar en cuenta estas otras posibilidades, obtenemos a continuación soluciones del problema a partir de $(x, \gamma)$ o de $(y, \gamma)$ cuando la otra coordenada de la posición se descarta.
