...
\begin{figure}[H]
    \centering
    \begin{adjustbox}{scale = 0.65, max width=\columnwidth}
        \framebox{\includegraphics{10-qplot_Qc_Qj_Fanuc_4.pdf}}
    \end{adjustbox}
    \caption{qplot Qc(ctraj) vs Qj(jtraj).}
\end{figure}

\begin{figure}[H]
    \centering
    \begin{adjustbox}{scale = 0.65, max width=\columnwidth}
        \framebox{\includegraphics{11-qplot_Qcd_Qjd_Fanuc_4.pdf}}
    \end{adjustbox}
    \caption{qplot QcD(vel. ctraj) vs QjD(vel. jtraj).}
\end{figure}

\begin{figure}[H]
    \centering
    \begin{adjustbox}{scale = 0.65, max width=\columnwidth}
        \framebox{\includegraphics{12-qplot_Qcdd_Qjddd_Fanuc_4.pdf}}
    \end{adjustbox}
    \caption{qplot QcDD(acel. ctraj) vs QjDD(acel. jtraj)}
\end{figure}

\begin{figure}[H]
    \centering
    \begin{adjustbox}{scale = 0.65, max width=\columnwidth}
        \framebox{\includegraphics{13-qplot_xtraj_Fanuc_4.pdf}}
    \end{adjustbox}
    \caption{qplot x, xD, xDD.}
\end{figure}
%\begin{equation*}
%    \prescript{O}{}{Rot_M} = 
%    \begin{bmatrix}
